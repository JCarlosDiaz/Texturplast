...
--
-- Servidor: localhost
-- Tiempo de generación: 14-11-2018 a las 23:42:33
...
(1, 'Angel', 'Aguilar', 'angel@ejemplo.com', 999, 'Quintana Roo', 77500);
...
(22, 'texturbond-plus-concreto', 'Texturbond Plus / para concreto', 'selladores-adhesivos', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
(37, 'blanco-10a', 'Blanco 10 años', 'impermeabilizantes', 'El impermeabilizante Texturplast está fabricado con polímeros acrílicos, cargas minerales, pigmentos inorgánicos y aditivos. Se utiliza para impermeabilizar y proteger losas de concreto, techumbres de lámina, fibrocemento y acabados térmicos de poliuretano. ', '1 a 1.5 metros cuadrados a una mano dependiendo de la superficie.', 'fichas/imper/F-Impermeabilizantes.pdf', 'Excelente cobertura.<br> 100% tallable y lavable.<br> Lavado con agua y jabón.', 'images/imper/impermeabilizante blanco.jpg', 'Remover con espátula o cepillo de alambre la pintura que se encuentre en mal estado y asegurarse de nivelar los puntos donde pueden existir encharcamientos y limpiar las bajadas de agua.', '', '', 'Limpiar la superficie de polvo, óxidos o grasa para asegurarnos de tener una buena adherencia. Deberá estar libre completamente de humedad para no tener problemas de desprendimientos.', '', '', '', 'Aplicar sellador Texturplast sin diluir en el sustrato para lograr un mejor rendimiento del impermeabilizante y garantizar su adherencia.', 'Reparar las grietas visibles con cemento plástico Texturplast, el cual debe aplicarse con cuña o espátula y asegurarse que las grietas no mayores a 4 mm de espesor. Para grietas mayores habrá que reparar con malla de refuerzo y la aplicación del cemento plástico del cemento plástico sobre la malla para darle cuerpo monolítico.', 'Mezclar bien el impermeabilizante  y después aplicar una primera mano con rodillo de felpa corta. Esperar 1 hora y aplicar la segunda mano en sentido cruzado con respecto a la primera mano.', '60 a 70 mins primera capa, 2 hrs re-aplicado', '1 Lt<br> 4 Lts<br> 19 Lts', ''),
...
(46, 'Pegazulejo-normal', 'Pegazulejo ', 'pegazulejos', 'Es un adhesivo para pisos elaborado a base de cemento portland, cargas minerales, resinas en polvo y aditivos que le confieren propiedades destacadas como son la flexibilidad para absorber los cambios estructurales por temperaturas y una gran adhesividad para sostener la loseta en muros sin que se desprenda.', '1 a 3 m2 por saco dependiendo del nivel del firme', 'fichas/pegazulejo/PEGAZULEJO PSP.pdf', 'Acabado blanco y gris.<br>Gran resistencia a la tensión.<br>Gran resistencia a la compresión.', 'images/pegazulejo/Pegazulejo.jpg', 'Antes de preparar la mezcla es necesario acondicionar la superficie y cuidando que esté seca, sin grietas, libre de aceite, grasa, polvo, eflorescencia, pintura, cera o cualquier otro tipo de impureza que inhiba la adherencia. \r\nPara una instalación de piso sobre piso es necesario limpiar con un limpiador alcalino para dejar la superficie libre de grasas ya que la simple limpieza con agua no es suficiente.', 'Mezclar un bulto de Pegazulejo Texturplast con 5 litros de agua y mezclar hasta tener una pasta homogénea y esperar 10 minutos para que todos los aditivos hagan su función correctamente.\r\n No agregue más agua.', 'Mantenga el adhesivo preparado a la sombra, No mezclar directamente sobre pisos de concreto, No se recomienda para superficies permanentemente sumergidas en agua, No se recomienda su uso en temperaturas menores a 5¼ C', '', 'Aplicar con llana dentada y extender una capa uniforme de pasta asegurándonos que el de tener una capa uniforme y nivelada. Asentar la loseta con cuidado procurando que toda la pieza asiente sobre la pasta colocada, golpeando con un mazo de hule en toda la loseta.\r\n', '', '', '', '', '', '', 'Bulto de 20 kgs', ''),
...
(56, 'texturblock-plus', 'Texturblock Plus', 'productos-especiales', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
(59, 'sombreador-blind-invernaderos', 'Sombreador Blind para Invernaderos', 'productos-especiales', 'Recubrimiento cementicio elaborado a base de cemento portland, cargas minerales, resinas, pigmentos y fibras.', '3.5 hasta 15 m2 dependiendo del espesor.', 'fichas/especiales/TEXTURBLOCK.pdf', 'Acabado blanco o beige.<br>No contiene mercurio ni plomo.<br>Ecológico', 'images/especiales/Texturblock.jpg', 'Humedecer la superficie con agua.', 'Mezclar un bulto de Texturblock con 8 litros de agua y mezclar hasta tener una pasta homogénea. ', '', 'Limpiar la superficie de polvo o grasa para asegurarnos de tener una buena adherencia.  Deberá estar libre de salitre para no tener problemas de desprendimientos y eflorescencias futuras.', 'Aplicar con llana una capa uniforme de Texturblock y dependiendo del desnivel que tenga la superficie será el espesor de la aplicación. Texturizar.  Aplicar con llana una capa uniforme de Texturblock y dependiendo del desnivel que tenga la superficie será el espesor de la aplicación.', '', '', '', '', '', 'Secado al tacto: 45 mins, Secado total: 24 hrs', 'Bulto de 40 kgs', ''),
(60, 'solvente-sombreador-blind', 'Solvente para Sombreador Blind', 'productos-especiales', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(61, 'boquilla', 'Boquilla ', 'pegazulejos', 'Es un rellenador de juntas para pisos elaborado a base de cemento portland, pigmentos, cargas minerales, resinas en polvo y aditivos que le confieren propiedades destacadas como son la solidez del color, la flexibilidad para absorber los cambios estructurales y por temperaturas, impermeabilidad, fluidez, facilidad de limpieza, evita la eflorescencia del salitre y no se agrieta.', '20 a 40 m2 por saco dependiendo de la profunidad y ancho de la junta.', 'fichas/pegazulejo/BOQUILLA.pdf', 'Variedad de colores claros y oscuros.<br>Evita filtraciones de agua.<br>Excelente rendimiento', 'images/pegazulejo/Boquilla.jpg', 'Humedecer la superficie con agua.', 'Mezclar un bulto de boquilla con 2.5 litros de agua y mezclar hasta tener una pasta homogénea y esperar 10 minutos para que todos los aditivos hagan su función correctamente.\r\nNo agregue más agua.', 'Almacenar en un lugar seco, No debe almacenarse por más de 3 meses.', 'Limpiar la superficie de polvo o grasa para asegurarnos de tener una buena adherencia.', 'Aplicar con jalador o con flota y extender una capa uniforme de pasta asegurándonos que el producto penetra en toda la unión entre loseta y loseta sin dejar burbujas y perfectamente  nivelada. Esperar a que seque al tacto durante 20 minutos y después proceda a limpiar con un trapo o esponja limpia enjuagando periódicamente para poder seguir recogiendo el exceso de boquilla que haya quedado en la superficie de la loseta cuidando no remover la pasta que quedó como junta entre piso y piso.', '', '', '', '', '', 'Secado al tacto: 45 mins, Secado total: 24 hrs', 'Bulto de 20 kgs', '');

...
-- Tiempo de generación: 04-10-2018 a las 18:14:55
...
(1, 'textur-premium', 'Textur Premium', 'pinturas', 'Para crear un ambiente clásico y con la mejor proteccion, elige Textur Premium', '12 a 14 metros cuadrados por litro. A una mano', 'fichas/pinturas/F-Textur-Premium.pdf', '100% acrilica<br>Exteriores/Interiores<br>', 'images/pinturas/texturpremium.jpg', 'Remover con espátula o cepillo de alambre la pintura que se encuentre en mal estado.', 'Mezclar bien la pintura y después diluir con agua limpia en cantidades que pueden ser desde un 10% hasta un 20% dependiendo de la viscocidad que se requiera para aplicarse ya sea con rodillo, brocha o pistola airless.', 'Se recomienda sellar la superficie con sellador 5x1 Texturplast para obtener el mejor rendimiento y anclaje de la pintura.', 'Limpiar la superficie de polvo o grasa para asegurarnos de tener una buena adherencia. Deberá estar libre completamente de humedad para no tener problemas de desprendimientos.', 'Aplique Textur Premium® a 2 manos con brocha, rodillo o equipo de aspersión airless, dejando secar 60 minutos entre mano y mano.', '', 'En caso necesario lave sus manos y equipos de aplicación en un recipiente con agua.', '', '', ''),
